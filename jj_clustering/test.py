def test():
    ...
    train1 = pd.read_csv('jj_clustering\data\\xav_train1.csv')
    train2 = pd.read_csv('jj_clustering\data\\xav_train2.csv')
    train3 = pd.read_csv('jj_clustering\data\\xav_train3.csv')
    test1 = pd.read_csv('jj_clustering\data\\xav_test1.csv')
    test2 = pd.read_csv('jj_clustering\data\\xav_test2.csv')
